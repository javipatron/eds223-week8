...
data <- file.path(rootdir,"data", "week8-data")
...
```{r include=TRUE}
landsat_20180612 <-rast(file.path(data, "landsat_20180612.tif"))
landsat_20180815 <-rast(file.path(data, "landsat_20180815.tif"))
landsat_20181018 <- rast(file.path(data, "landsat_20181018.tif"))
landsat_20181103 <- rast(file.path(data, "landsat_20181103.tif"))
landsat_20190122 <- rast(file.path(data, "landsat_20190122.tif"))
landsat_20190223 <- rast(file.path(data, "landsat_20190223.tif"))
landsat_20190412 <- rast(file.path(data, "landsat_20190412.tif"))
landsat_20190701 <- rast(file.path(data, "landsat_20190701.tif"))
```
...
sites <- st_read("/Users/javipatron/Documents/MEDS/Courses/eds223/data/week8-data/study_sites.shp")
